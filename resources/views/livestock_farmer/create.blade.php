...
<div class="container">
    ...
    -->
    <form action="{{ url('/livestock_farmer') }}" method="post">  <!--enctype="multipart/form-data" para poder enviar archivos de imágenes-->
    @csrf <!--TOKEN DE SEGURIDAD: ENVÍO DE DATOS DESDE EL FORMULARIO-->      
    @include('livestock_farmer.form',['modo'=>'Añadir registro'])
    </form>
</div>
@endsection