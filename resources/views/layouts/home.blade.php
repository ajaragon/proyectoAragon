            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container-fluid">
                        ...
                        <a class="navbar-brand" href="#"><img src="{{ url('images/logo.png') }}" id="logo"></a>
                        ...
                        <div class="collapse navbar-collapse ms-lg-5" id="navbarNav">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active text-reset" aria-current="page" href="#">Quiénes somos</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active text-reset" aria-current="page" href="#">Blog</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active text-reset" aria-current="page" href="#">Contacto</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Fin de menú -->
            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light justify-content-around">
                    <div class="container-fluid">
                        ...
                        <!-- Logo -->
                        <a href="#" class="col-lg-4 d-flex align-items-center">
